 ...
 * customer can purchase with coupons
 *
...
int main(){
    ...
    //calculate candbars
    candybarsBought=couponsRemaining/CANDY_BARS_PRICE;
    couponsRemaining=couponsRemaining%CANDY_BARS_PRICE;
    
    //calculate gumballs and remaining coupons
    gumballsBought=couponsRemaining/GUMBALLS_PRICE;
    couponsRemaining=couponsRemaining%GUMBALLS_PRICE;
